...
export const History = ({ userSetting }: HistoryProps) => {
  ...
  const dataAvaible = historyDataQuery.data && historyDataQuery.data.length > 0;
        ...
        <CardContent>
          <SkeletonWrapper isLoading={historyDataQuery.isFetching}>
            ...
            {!dataAvaible && (
              ...
              flex-col items-center justify-center bg-background"
              >
                No data for the selected period
                <p className="text-sm text-muted-foreground">
                  Try selecting an other period or adding new transactions
                </p>
              </Card>
            )}
          </SkeletonWrapper>
