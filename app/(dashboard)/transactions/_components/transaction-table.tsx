import { TransactionHistoryResponseType } from "@/app/api/transactions-history/route";
...
type TransactionHistoryRow = TransactionHistoryResponseType[0];
      ...
      return (
        <div
          className={cn(
            ...
            row.original.type === "expense" && "bg-pink-400/10 text-pink-500",
          )}
        >
          {row.original.type}
        </div>
...
export const TransactionTable = ({ from, to }: TransactionTableProps) => {
  ...
  const history = useQuery<TransactionHistoryResponseType>({
    ...
    <div className="w-full">
      <div className="flex flex-wrap items-end justify-between gap-2 py-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          >
            <DownloadIcon className="mr-2 size-4 w-4" /> Export CSV
          </Button>
